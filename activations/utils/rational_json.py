...
class JsonHandler:
    ...
    def set_current(cls, path):
        ...
        cls._known_rationals = {
            version: [func for func in data[version]] for version in data
        }
    ...
    def is_stored(cls, version, degrees, name):
        ...
        return (version in cls._known_rationals) and (
            name in cls._known_rationals[version]
        )
